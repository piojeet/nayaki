  ...
  return (
    <div>
        <div className='max-w-[1440px] mx-auto flex justify-between items-center p-4 md:px-8 releative'>
            ...
            <div className='flex itcems-center gap-4 text-sm font-IndieFlower'>
                <button className='bg-accent/20 text-light py-2 md:px-8 px-4 rounded-full tracking-[1px] border border-[#313131]'>The Job Journal</button>
                <button className='bg-accent/20 text-light py-2 md:px-8 px-4 rounded-full tracking-[1px] border border-[#313131]'>Job Jarvis</button>
            </div>
