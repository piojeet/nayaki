  ...
  return (
    <div>
        <div className='max-w-[1440px] mx-auto flex justify-between items-center p-4 md:px-8 releative'>
            ...
            <div className='flex itcems-center gap-4'>
            ...
            <div className='absolute flex items-center left-1/2 transform -translate-x-1/2 text-5xl font-bold flex items-center gap-2'>
